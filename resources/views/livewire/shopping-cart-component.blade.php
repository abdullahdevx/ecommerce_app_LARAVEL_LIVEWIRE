    ...
    @foreach($item as $items)
      {{-- <div wire:key="{{$items->id}}"> --}}
        ...
        <div class="rounded-lg md:w-2/3">
          <div class="justify-between mb-6 rounded-lg bg-white p-30 shadow-md sm:flex sm:justify-start p-1 h-[100px]">
            ...
            <div class="sm:ml-4 sm:flex sm:w-full sm:justify-between">
              ...
              <div class="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                ...
                <div class="flex items-center space-x-4">
                  ...
                  <p class="text-sm">{{number_format($items->product->price)}} rs</p>
      ...
      {{-- @foreach($item as $items) --}}
        ...
        <div class="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
          <div class="mb-2 flex justify-between">
            ...
            <p class="text-gray-700">{{number_format($subTotal)}} rs</p>
          </div>
          <div class="flex justify-between">
            <p class="text-gray-700">Shipping</p>
            <p class="text-gray-700">120 rs</p>
          </div>
          <hr class="my-4" />
          <div class="flex justify-between">
            <p class="text-lg font-bold">Total</p>
            <div class="">
      <p class="mb-1 text-lg font-bold">{{number_format($subTotal + 120)}} rs</p>
