    ...
    <div class="fixed-center inset-0 bg-gray-500 opacity-300 ">
        ...
        <div class="bg-white rounded m-auto fixed inset-0 max-w-2xl" style="max-height:700px; max-width:900px; top:5%; left:10%;">
            ...
            <div class="flex items-center justify-center">
              ...
              <form wire:submit="success()" class="w-full max-w-lg">
              ...
              <div class="w-full md:w-1/2 px-3">
                ...
                <button wire:click="processPayment()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                  PAY ONLINE
                </button>
              </form>
      </div>
